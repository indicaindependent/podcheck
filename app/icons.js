/* VibeMaestro canonical icon library (baked into build image).
   Usage in app.js/HTML:  icon('plus')  ->  returns inline <svg> string.
   All 16px, stroke=currentColor, fill=none, stroke-width=2, rounded, aria-hidden.
   NEVER emoji. NEVER hand-write SVG paths in build output — call icon(name). */
(function (root) {
  var P = {
